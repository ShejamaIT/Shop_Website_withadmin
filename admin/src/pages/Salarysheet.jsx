...
//     // Safely parse numeric values from formData
//     const basic = parseFloat(formData.basic) || 0;
...
//     let s_total = basic + attendance - deduction - totalAdvance - totalLoan - saving - other;
...
//     // Conditionally add loanDate if present
//     if (loanPayments?.date) {
//         updatedData.loanDate = loanPayments.date;
//     }

//     updatedData.total = s_total.toFixed(2);
//     setFormData(updatedData);

// }, [
//     formData.basic, formData.attendance,formData.leaveDeduction,formData.saving,formData.otherpay,highestSaleBonus,
//     advancePayments,loanPayments,monthlyTargetBouns,dailyTargetBouns, monthlyDeptBalance,inOrderBonus, outOrderBonus
// ]);
...
//   // Update formData1 with new leave values
//   const updatedLeave = {
//     ...formData1,
//     [name]: numericValue,
//   };
...
//   // Calculate deduction
//   const informed = name === "informedLeave" ? numericValue : formData1.informedLeave;
//   const uninformed = name === "uninformedLeave" ? numericValue : formData1.uninformedLeave;
//   const deduction = informed * 1000 + uninformed * 2000;
...
//                                         type="number"
//                                         name="uninformedLeave"
//                                         value={formData1.uninformedLeave}
//                                         onChange={handleLeaveChange}
//                                         />
//                                     </td>
//                                     </tr>
//                                     <tr>
//                                     <td><strong>Leave Deduction</strong></td>
//                                     <td colSpan="3">{formData.leaveDeduction}</td>
//                                     </tr>
