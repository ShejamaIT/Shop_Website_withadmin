                                        ...
                                        <Button
                                            ...
                                            onClick={() => {
                                                ...
                                                const path = order.orderStatus === "Delivered"
                                                    ? (userType === "ADMIN"
                                                        ? "/admin-dashboard/product_list?tab=Delivered%20Orders"
                                                        : "/user-dashboard/product-list?tab=Delivered%20Orders")
                                                    : (userType === "ADMIN"
                                                        ? "/admin-dashboard/product_list?tab=Issued%20Orders"
                                                        : "/user-dashboard/product-list?tab=Issued%20Orders");
                                                navigate(path);
                                            }}
                                        >
