                ...
                <div className="mb-4">
                    ...
                    <div className="flex mb-4">
                        <div className="w-1/3 mx-2">
                            ...
                            <input type="number" id="availableQty" className="mt-1 p-2 border border-gray-300 rounded-md w-full" value={orderData.availableQty} disabled />
                        </div>
                        <div className="w-1/3 mx-2">
                            <label htmlFor="productSellingPrice" className="block text-sm font-medium text-gray-700">Product Unit Selling Price</label>
                            <input type="number" id="productSellingPrice" className="mt-1 p-2 border border-gray-300 rounded-md w-full" value={orderData.productSellingPrice} disabled />
                        </div>
                        <div className="w-1/3">
                            <label htmlFor="quantity" className="block text-sm font-medium text-gray-700">Quantity</label>
                            <input type="number" id="quantity" className="mt-1 p-2 border border-gray-300 rounded-md w-full" value={orderData.quantity} onChange={handleChange} />
                        </div>
                    </div>
                ...
                {isCashPayment && (
                    <div id="cashDetails" className="mb-4">
                        <div className="mb-4">
                            ...
                            <input type="number" id="amountPaid" className="mt-1 p-2 border border-gray-300 rounded-md w-full" value={orderData.amountPaid} onChange={handleChange} />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="balance" className="block text-sm font-medium text-gray-700">Balance</label>
                            <input type="number" id="balance" className="mt-1 p-2 border border-gray-300 rounded-md w-full" value={orderData.balance} disabled />
                        </div>
                    </div>
                )}
