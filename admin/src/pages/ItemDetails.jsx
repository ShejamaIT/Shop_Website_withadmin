...
//     const [activeTab, setActiveTab] = useState("Available");  // Set default tab
//     const [stock, setStock] = useState({ available: [], reserved: [], damage: [] });
//     const [item, setItem] = useState(null);  // Assuming you are fetching item data as well
...
//
//             // Check if stockDetails is an array
//             if (Array.isArray(data.item.stockDetails)) {
//                 setStock({
//                     available: data.item.stockDetails.filter((stock) => stock.status === "available"),
//                     reserved: data.item.stockDetails.filter((stock) => stock.status === "reserved"),
//                     damage: data.item.stockDetails.filter((stock) => stock.status === "damage"),
//                 });
//             } else {
//                 // Handle case when stockDetails is not an array
//                 console.error("stockDetails is not an array:", data.item.stockDetails);
//                 setStock({ available: [], reserved: [], damage: [] }); // Set empty arrays to prevent crashes
//             }
//
//             setItem(data.item);
...
//
//     useEffect(() => {
//         fetchItem();  // Fetch item details when the component mounts
//         console.log(stock);
...
//                                                     </table>
//                                                 ) : (
//                                                     <p className="text-center">No available stock details available</p>
//                                                 )}
//                                             </Col>
//                                         </Row>
//                                     </TabPane>
//
//                                     {/* Reserved Stock Tab */}
//                                     <TabPane tabId="Reserved">
//                                         <Row>
//                                             <Col>
//                                                 {stock.reserved.length > 0 ? (
//                                                     <table className="table table-striped table-bordered">
//                                                         <thead>
//                                                         <tr>
//                                                             <th>ID</th>
...
//                                                     </table>
//                                                 ) : (
//                                                     <p className="text-center">No reserved stock details available</p>
//                                                 )}
//                                             </Col>
//                                         </Row>
//                                     </TabPane>
//
//                                     {/* Damage Stock Tab */}
//                                     <TabPane tabId="Damage">
//                                         <Row>
//                                             <Col>
//                                                 {stock.damage.length > 0 ? (
//                                                     <table className="table table-striped table-bordered">
//                                                         <thead>
//                                                         <tr>
//                                                             <th>ID</th>
...
//                                                     </table>
//                                                 ) : (
//                                                     <p className="text-center">No damage stock details available</p>
//                                                 )}
//                                             </Col>
//                                         </Row>
//                                     </TabPane>
