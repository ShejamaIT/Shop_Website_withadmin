                ...
                <Col lg="8" className="mx-auto">
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <FormGroup>
                            ...
                            <Input type="number" name="basic" id="basic" value={formData.basic} readOnly />
                        </FormGroup>

                        <FormGroup>
                            <Label for="loan">Loan Amount</Label>
                            <Input type="number" name="loan" id="loan" value={formData.loan} onChange={handleChange} required />
                        </FormGroup>
                        ...
                        <FormGroup>
                            ...
                            <Input type="number" name="installment" id="installment" value={formData.installment} readOnly />
                        </FormGroup>
                        <Row>
                            <Col md="6">
